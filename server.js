...
// link to the accounting so we can format currency values
...
var goodbyeWorld = function(req, res, next) {
  res.writeHead(200, {
    ...
    res.end('Goodbye World. Will this restart automatically? YES!');
};
